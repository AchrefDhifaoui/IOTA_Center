...
final class Version20240229204544 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formation_assurer (id INT AUTO_INCREMENT NOT NULL, formation_id INT NOT NULL, date_debut DATE DEFAULT NULL, unite VARCHAR(20) NOT NULL, quantite INT NOT NULL, prix_total DOUBLE PRECISION NOT NULL, INDEX IDX_6B835B465200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE formation_assurer ADD CONSTRAINT FK_6B835B465200282E FOREIGN KEY (formation_id) REFERENCES formation (id)');
    }
