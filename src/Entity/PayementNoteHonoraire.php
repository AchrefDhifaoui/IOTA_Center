...
#[ORM\Entity(repositoryClass: PayementNoteHonoraireRepository::class)]
class PayementNoteHonoraire
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'payementNoteHonoraires')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ModePayement $modePayement = null;

    #[ORM\ManyToOne(inversedBy: 'payementNoteHonoraires')]
    #[ORM\JoinColumn(nullable: false)]
    private ?NoteHonoraire $note = null;
    ...
    public function getNote(): ?NoteHonoraire
    {
        return $this->note;
    }

    public function setNote(?NoteHonoraire $note): static
    {
        $this->note = $note;
