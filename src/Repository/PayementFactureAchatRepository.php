...
/**
 * @extends ServiceEntityRepository<PayementFactureAchat>
 */
class PayementFactureAchatRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, PayementFactureAchat::class);
    }

    //    /**
    //     * @return PayementFactureAchat[] Returns an array of PayementFactureAchat objects
    //     */
    ...
    //    public function findOneBySomeField($value): ?PayementFactureAchat
    //    {
    //        return $this->createQueryBuilder('p')
    //            ->andWhere('p.exampleField = :val')
    //            ->setParameter('val', $value)
    ...
    public function getTotalPayementFactureAchatLast12MonthsGrouped(): array
    {
        $conn = $this->getEntityManager()->getConnection();
        $sql = '
